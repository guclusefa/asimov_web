...
-- Generation Time: Mar 11, 2022 at 02:23 PM
...
ALTER TABLE `Notes`
  ...
  ADD KEY `note_idParticipation` (`note_idCursus`),
  ADD KEY `note_idCursusProf` (`note_idProf`),
...
ALTER TABLE `Cursus_Profs`
  ...
  ADD CONSTRAINT `Cursus_Profs_ibfk_3` FOREIGN KEY (`cursus_prof_idProf`) REFERENCES `Users` (`user_id`) ON UPDATE CASCADE;

--
-- Constraints for table `Notes`
--
ALTER TABLE `Notes`
  ADD CONSTRAINT `Notes_ibfk_1` FOREIGN KEY (`note_idCursus`) REFERENCES `Cursus` (`cursus_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `Notes_ibfk_4` FOREIGN KEY (`note_idMatiere`) REFERENCES `Matieres` (`matiere_id`) ON DELETE CASCADE ON UPDATE CASCADE;
